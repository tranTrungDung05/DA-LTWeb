...
{
    /// <inheritdoc />
    public partial class InitialIdentityCoreSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermanentAddress = table.Column<string>(type: "nvarchar(240)", maxLength: 240, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    DocumentPath = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Condition = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    RoomId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantRooms", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Chu tro", "Owner", "OWNER" },
                    { 2, null, "Khach thue", "Tenant", "TENANT" },
                    { 3, null, "Quan tri he thong", "Admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "Properties",
                columns: new[] { "Id", "Address", "Name", "PhoneNumber" },
                values: new object[] { 1, "Cap nhat dia chi nha tro", "Nha tro mac dinh", "0900000000" });
